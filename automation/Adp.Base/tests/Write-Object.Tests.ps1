Describe 'Write-Object' {
    ...
    It 'handles null' {
        ...
        $iv[0].MessageData.Message | Should -Be '[null]'
    }
    ...
    It 'shows name label when provided' {
        ...
        $iv[0].MessageData.Message | Should -Be '--- MyLabel ---'
    }
