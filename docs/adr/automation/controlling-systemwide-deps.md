...
- **CI and local use the same code path.** No separate CI setup scripts. The same `Install-DevBoxTools` that runs on a developer workstation runs in the pipeline.
